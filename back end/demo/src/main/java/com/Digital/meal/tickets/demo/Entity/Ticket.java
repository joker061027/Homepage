...
public class Ticket {
    ...
    @Column(name = "StallId",length = 64,nullable = false)
    private String stallId;  //档口Id

    @Column(name = "UsedId",length = 64,nullable = false)
    private String usedId;  //使用者Id

    @Column(name = "CheckId",length = 64,nullable = false)
    ...
    private String staus;  // 状态（0-未使用，1-已核销，2-已过期）
